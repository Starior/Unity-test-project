...
public class GameController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        scoreTxt.text = "<size=40><color=#C34040>best:</color></size> " + PlayerPrefs.GetInt("score") + "<size=30> now:</size> 0";
    ...
    private void MoveCameraChangeBg()
    {
        ...
        scoreTxt.text = "<size=40><color=#C34040>best:</color></size> "+ PlayerPrefs.GetInt("score") + "<size=30> now:</size>" + maxY;
